class Ocelot < Formula
  ...
  homepage "https://github.com/catto-oss/ocelot"
  url "https://github.com/catto-oss/ocelot/archive/refs/tags/v0.1.0.tar.gz"
  ...
  on_macos do
    on_arm do
      url "https://github.com/catto-oss/ocelot/releases/download/v0.1.0/ocelot-macos-aarch64"
      sha256 "00a6fcb8b4c05fb32f6a87a443e974d009a8a4c98f1334d106f25345d4938641"
    end

    on_intel do
      url "https://github.com/catto-oss/ocelot/releases/download/v0.1.0/ocelot-macos-x86_64"
  ...
  on_linux do
    on_intel do
      url "https://github.com/catto-oss/ocelot/releases/download/v0.1.0/ocelot-linux-x86_64"
